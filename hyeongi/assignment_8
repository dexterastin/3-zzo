...
diction1 = {}
num_list = ['3.141592','3E+8','340','1.5E+8']
for i in range(0,4):
    diction1[str(constantList[i])] = num_list[i]
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.clear()
        elif key in diction1:
            self.display.setText(self.display.text() + diction1[key])
            ...
            list2 = []
            for i in range(0,4):
                diction2[str(functionList[i])]=calcFunctions.cala(i,n)
            value=diction2[key]
